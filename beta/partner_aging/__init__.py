...
######################################################################
#
#  partner_aging - INTERACTIVE PARTNER AGING for OpenERP 
#  Copyright (C) 2012 - TODAY, Ursa Information Systems (<http://ursainfosystems.com>)
#  Copyright (C) 2004-2010 Tiny SPRL (<http://tiny.be>)
#  contact@ursainfosystems.com
#
#  This module builds on a Vauxoo module at http://v6apps.openerp.com/addon/7894
#  that module copyright (C) 2011 Vauxoo - http://www.vauxoo.com/
#
