...
class AccountInvoiceLine(orm.Model):
    ...
    def product_id_change(
        self, cr, uid, ids, product, uom_id,
        ...
        """Overwrite of product on change in order
        to set the product invoice description
        in invoice line note. We also set name
        of product in invoice line name"""

        # Can you feel the pain?
        res = super(AccountInvoiceLine, self).product_id_change(
            cr, uid, ids, product, uom_id,
        ...
        product_note = pobj.read(
            cr, uid, product, ['description'], context=context)
